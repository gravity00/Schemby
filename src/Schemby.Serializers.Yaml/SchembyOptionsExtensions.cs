...
{
    /// <summary>
    /// Adds the YAML serializer to the Schemby options.
    /// </summary>
    ...
    public static SchembyOptions WithYamlSerializer(this SchembyOptions options, string name = "yaml")
    {
        ...
        options.Serializers[name] = new YamlSerializerInstaller();
        return options;
    }
}